          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{URL::to('/delete-product/'.$pro ->product_id)}}" class="active styling-delete" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm này không?')" ui-toggle-class=""><i class="fa fa-times text-danger text"></i></a>
              </td>
            </tr>                      
            @endforeach
          </tbody>
