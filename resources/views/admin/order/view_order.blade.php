  ...
  <div class="table-agile-info">
    <div class="panel panel-default">
      ...
      <div class="table-responsive">
        ...
        <table class="table table-striped b-t b-light">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input id="ip_or" type="number" min="1" {{$order_status==2 ? 'disabled' : ''}} class="order_qty_{{$ord_de->product_id}}" value="{{$ord_de->product_sales_quantity}}" name="product_sales_quantity">
              ...
              @if($order_status!=2) 
                <button class="btn btn-info update_quantity_order" data-product_id="{{$ord_de->product_id}}" name="update_quantity_order"><span style="font-family: wingdings; font-size: 90%;">&#10004;</span></button>
              @endif
        ...
        <a target="_blank" href="{{url('/print-order/'.$ord_de->order_code)}}" class="print-order">In đơn hàng</a>
      </div>
    </div>
  </div>
@endsection
